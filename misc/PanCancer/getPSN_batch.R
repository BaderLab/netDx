...
###cat("one rna net\n")
###setwd("featSel_oneNetPer")
###source("KIRC_RNA_oneNetPer_PSN.R")

#cat("one protein net\n")
#setwd("featSel_oneNetPer")
#source("KIRC_Prot_oneNetPer_PSN.R")

###cat("OV clin\n")
###setwd("featSel_oneNetPer")
###source("OV_clin_oneNetPer_PSN.R")
browser()
...
inFile <- list(
	...
	OV_oneClinNet="oneNetPer_FeatSel/OV",
	oneRNANet="oneNetPer_FeatSel/RNA"
)
