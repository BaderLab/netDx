...
inDir <- "/Users/shraddhapai/Documents/Research/BaderLab/2017_TCGA_SKCM/output/integrate_170131"

combSet <- c("xpr","dnam","mir","xprdna","all")
...
for (rngSeed in seq(10,100,10)) {
	...
	#				 worse=outRes$worse$precall)
		...
		pred <- prediction(dat$LOW_SCORE-dat$HIGH_SCORE,
						  dat$STATUS=="LOW")
...
# plot
pdf("SKCM_perf.pdf",width=8,height=4)
tryCatch({
...
pdf("SKCM_perf_ROC.pdf",width=11,height=4)
