...
# create ID and STATUS column for phenotype table
pID <- colData(brca)$patientID
colData(brca)$ID <- pID
colData(brca)$STATUS <- gsub(" ","_",colData(brca)$pam_mod)

# prepare grouping rules for feature design
groupList <- list()
...
# define the function to generate similarity networks
# This will be passed to the buildPredictor() call using 
# the makeNetsFunc parameter.
...
# compute accuracy for each split and class
