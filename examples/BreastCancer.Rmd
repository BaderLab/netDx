...
dbDir   <- compilePSN(profDir, pheno$ID, outDir,numCores=numCores)
...
for (g in subtypes) {
        ...
        # create db
        dbDir <- compilePSN(profDir,pheno$ID,pDir,numCores=numCores)
...
* `compilePSN`: Create the new database from the resulting nets
