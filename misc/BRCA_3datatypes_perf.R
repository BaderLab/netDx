...
inDir <- "/Users/shraddhapai/Documents/Research/BaderLab/TCGA_breastCancer/output/data3_170118"

combSet <- c("xpr","dnam","mir",
	"xprdnam","xprmir","dnamir","all")
cols <- c(rep("red",3),rep("blue",3),"orange")
