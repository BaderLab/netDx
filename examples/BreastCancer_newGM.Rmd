...
outDir <- sprintf("%s/TCGA_BRCA_new",getwd())
...
for (g in subtypes) {
    ...
    if (file.exists(pDir)) unlink(pDir,recursive=TRUE)
        ...
        GM_runCV_featureSet(trainPred, resDir, dbDir$dbDir,
                ...
                GMmemory=GMmemory, useNewGM=TRUE)
    ...
    # Compute network score
        pTally          <- GM_networkTally(paste(resDir,nrank,sep="/"), useNewGM=TRUE)
        head(pTally)
        # write to file
