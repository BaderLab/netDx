...
# plot
pdf("OV_perf.pdf",width=8,height=4)
tryCatch({
...
pdf("OV_perf_ROC.pdf",width=11,height=4)
...
outF <- sprintf("OV_%s_perf.Rdata", basename(inDir))
print(outF)
