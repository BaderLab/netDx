...
#dataDir_both <- "/home/shraddhapai/BaderLab/2017_PanCancer/GBM/output/prune_180124"
#dataDir <- "/home/shraddhapai/BaderLab/2017_PanCancer/GBM/output/PCA1net_180126"
#dataDir <- "/home/shraddhapai/BaderLab/2017_PanCancer/LUSC/output/pruneClinFix_180126"
dataDir <- "/home/shraddhapai/BaderLab/2017_PanCancer/LUSC/output/pruneCheckIntegr_180126"

outmat <- matrix(NA,nrow=3,ncol=9)
settypes <- c("clinical","prot","clinicalAprot")
...
write.table(outmat,file=sprintf("%s/perf.txt",outD),sep="\t",
			col=T,row=T,quote=F)
