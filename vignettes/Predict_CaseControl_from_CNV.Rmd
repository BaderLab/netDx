...
# run the predictor
predictClass	<- "case"
buildPredictor_sparseGenetic(pheno,predictClass,outDir,
...
Features are scored `splitN` times, each time leaving 1/Nth of the samples out.
...
```{r,eval=TRUE}
predictClass	<- "case"
buildPredictor_sparseGenetic(pheno,predictClass,
                             outDir,
                             splitN=3L, featScoreMax=3L,
                             enrichLabels=TRUE,numPermsEnrich=20L,
                             numCores=8L)
```
