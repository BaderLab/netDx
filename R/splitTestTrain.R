...
#' @param predClass (char) name of the patient class for which the 
#' predictor should be built. Should match a value in the STATUS column of
#' \code{pheno_DF}
...
IS_TRAIN[sample(plus_idx, floor(pctT*length(plus_idx)), F)] <- "TRAIN"
