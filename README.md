...
In order to generate and visualize patient similarity networks and enrichment maps from the data generated by netDx we will need Cytoscape.
Install the latest version of Cytoscape found at http://www.cytoscape.org.

To generate enrichment maps the "Enrichment Map" and "AutoAnnotate" apps must be installed in Cytoscape. This can be achieved through the Cytoscape app store. With Cytoscape
open, follow the instructions found at these links:
-AutoAnnotate v1.2 (http://apps.cytoscape.org/apps/autoannotate)
-Enrichment Map v3.0.0 (http://apps.cytoscape.org/apps/enrichmentmap)

To run Cytoscape-related functionality, such as network visualizations of patient similarity networks and enrichment maps, you will need EasyCyrest (v0.0.0.9) and
r2cytoscape (v0.0.3). Let us install directly from the github packages in R:
