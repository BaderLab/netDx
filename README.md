...
To generate enrichment maps the "Enrichment Map" and "AutoAnnotate" apps must be installed in Cytoscape. This can be achieved through the Cytoscape app store. With Cytoscape open, follow the instructions found at these links:
...
$ cd netDx-master/
$ R
> install.packages(c("bigmemory","foreach","combinat","doParallel","ROCR","pracma","RColorBrewer","reshape2","igraph","devtools"))
